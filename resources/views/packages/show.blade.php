...
@section('seo_image', filled($package->image_url) && \Illuminate\Support\Str::startsWith($package->image_url,
    ['http://', 'https://']) ? $package->image_url : (filled($package->image_url) ?
    \Illuminate\Support\Facades\Storage::url($package->image_url) : asset('favicon.ico')))
    ...
    <div class="min-h-screen">
        <section class="relative flex min-h-[max(500px,68vh)] items-end overflow-hidden"><img src="{{ $packageImageUrl }}"
            ...
            <div
                ...
                <div class="flex flex-wrap gap-2 mb-5">
                    <div
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            stroke-linejoin="round" class="lucide lucide-flame w-3 h-3">
                            <path
                ...
                <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 max-w-3xl leading-tight">
                    {{ $package->name }}
                </h1>
                    ...
                    @if ($package->days)
                        <span
                            class="inline-flex items-center gap-2 bg-primary-foreground/15 backdrop-blur border border-primary-foreground/20 px-4 py-2 rounded-xl text-sm"><svg
                                ...
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-clock w-4 h-4 text-primary">
                                <circle cx="12" cy="12" r="10"></circle>
                                <polyline points="12 6 12 12 16 14"></polyline>
                            </svg> {{ __('packages.show.days', ['count' => $package->days]) }}</span>
                    @endif
                    ...
                    @if ($package->destination)
                        <span
                            class="inline-flex items-center gap-2 bg-primary-foreground/15 backdrop-blur border border-primary-foreground/20 px-4 py-2 rounded-xl text-sm"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-map-pin w-4 h-4 text-primary">
                                <path
                    ...
                    @if (filled($package->location_label))
                        <span
                            class="inline-flex items-center gap-2 bg-primary-foreground/15 backdrop-blur border border-primary-foreground/20 px-4 py-2 rounded-xl text-sm"><svg
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="lucide lucide-tag w-4 h-4 text-primary">
                                <path
                                    d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a2.426 2.426 0 0 0 3.42 0l6.58-6.58a2.426 2.426 0 0 0 0-3.42z">
                                </path>
                                <circle cx="7.5" cy="7.5" r=".5" fill="currentColor"></circle>
                            </svg> {{ $package->location_label }}</span>
                    @endif
                </div>
                <a href="{{ $orderUrl }}"
            ...
            <div class="container mx-auto px-4 py-5">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-5 items-center">
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-clock w-5 h-5 text-primary shrink-0">
                            <circle cx="12" cy="12" r="10"></circle>
                            <polyline points="12 6 12 12 16 14"></polyline>
                        </svg>
                        <div>
                            <p class="text-[10px] uppercase tracking-wider text-muted-foreground">
                                {{ __('packages.show.duration') }}</p>
                    ...
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-map-pin w-5 h-5 text-primary shrink-0">
                            <path
                                d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0">
                            </path>
                            <circle cx="12" cy="10" r="3"></circle>
                    ...
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-credit-card w-5 h-5 text-primary shrink-0">
                            <rect width="20" height="14" x="2" y="5" rx="2"></rect>
                            <line x1="2" x2="22" y1="10" y2="10"></line>
                        </svg>
                        <div>
                            <p class="text-[10px] uppercase tracking-wider text-muted-foreground">
                                {{ __('packages.show.starting_from') }}</p>
                            <p class="text-sm font-bold text-foreground">
                                @if ($package->price > 0)
                    ...
                    <div class="flex items-center gap-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-calendar-days w-5 h-5 text-primary shrink-0">
                            <path d="M8 2v4"></path>
                            <path d="M16 2v4"></path>
                        ...
                        <div>
                            <p class="text-[10px] uppercase tracking-wider text-muted-foreground">
                                {{ __('packages.show.availability') }}</p>
                                ...
                                <div class="space-y-3" data-package-accordion>
                                    @foreach ($itineraryItems as $itineraryItem)
                                        @php
                                            ...
                                            $dayLabel =
                                                data_get($itineraryItem, 'day_label') ?:
                                        ...
                                        <div data-package-accordion-item data-state="{{ $isOpen ? 'open' : 'closed' }}"
                                            ...
                                            <h3 class="flex">
                                                ...
                                                @else
                                                    <div
                                                        class="flex flex-1 items-center justify-between gap-4 py-5 font-medium">
                                                        <div class="flex items-center gap-4">
                                                            <div
                                                                class="shrink-0 w-12 h-12 rounded-xl bg-primary/10 text-primary font-bold flex items-center justify-center text-sm">
                                                                {!! $renderPackageIcon(data_get($itineraryItem, 'icon')) !!}
                        ...
                        <div id="pkg-cta"
                            ...
                            <div class="pt-4 border-t border-border/60 space-y-2.5 text-xs text-muted-foreground">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span>{{ __('packages.show.secure_booking') }}</span>
                                </div>
                                <div class="flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <span>{{ __('packages.show.flexible_cancellation') }}</span>
                                </div>
                            </div>
                        </div>
                    </aside>
            ...
            <div class="container mx-auto max-w-6xl">
                <div class="text-center mb-14">
                    <p class="text-primary font-semibold tracking-[0.3em] uppercase text-xs mb-4">
                        {{ __('packages.show.trust_eyebrow') }}</p>
                    <h2 class="text-3xl md:text-5xl font-bold text-foreground">{{ __('packages.show.trust_title') }}</h2>
                </div>
                <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div
                        ...
                        <h3 class="text-base font-bold text-foreground">{{ __('packages.show.trust_items.0') }}</h3>
                    </div>
                    <div
                        class="text-center bg-card rounded-2xl p-7 border border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-300">
                        <div class="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-5">
                        ...
                        <h3 class="text-base font-bold text-foreground">{{ __('packages.show.trust_items.1') }}</h3>
                    </div>
                    <div
                        class="text-center bg-card rounded-2xl p-7 border border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-300">
                        <div class="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-5">
                        ...
                        <h3 class="text-base font-bold text-foreground">{{ __('packages.show.trust_items.2') }}</h3>
                    </div>
                    <div
                        class="text-center bg-card rounded-2xl p-7 border border-border/50 hover:border-primary/40 hover:shadow-lg transition-all duration-300">
                        <div class="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-5">
                        ...
                        <h3 class="text-base font-bold text-foreground">{{ __('packages.show.trust_items.3') }}</h3>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="relative py-28 overflow-hidden"><img src="#" alt=""
            ...
            <div
                class="absolute inset-0 bg-gradient-to-b from-[hsl(var(--hero-overlay))]/90 to-[hsl(var(--secondary))]/90">
            </div>
            <div class="relative z-10 container mx-auto max-w-3xl text-center text-primary-foreground px-4">
                <h2 class="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                    {{ __('packages.show.cta_title') }}</h2>
                <p class="text-primary-foreground/85 text-base md:text-lg mb-10">{{ __('packages.show.cta_description') }}
                </p>
        ...
        <a href="{{ $whatsappUrl }}" target="_blank" rel="noopener noreferrer"
            aria-label="{{ __('packages.show.chat_whatsapp') }}"
