        ...
        <div class="grid md:grid-cols-5 gap-10 mb-14">
            ...
            <div>
                ...
                <div class="flex flex-col gap-3 text-sm">
                    <a href="{{ route('home') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.home') }}</a>
                    <a href="{{ route('services.index') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.services') }}</a>
                    <a href="{{ route('packages') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.packages') }}</a>
                    <a href="{{ route('about') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.about') }}</a>
                    <a href="{{ route('contact') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.contact') }}</a>
                </div>
            </div>
            <div>
                ...
                <div class="flex flex-col gap-3 text-sm">
                    @foreach ($footerServices as $service)
                        <a href="{{ route('services.show', ['service' => $service->slug]) }}"
                           class="hover:text-primary transition-colors duration-300">{{ $service->name }}
                        </a>
                    @endforeach
                    <a href="{{ route('services.index') }}"
                       class="hover:text-primary transition-colors duration-300">{{ __('nav.all_services') }}
                    </a>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <div class="flex flex-col gap-4 text-sm"><span class="flex items-start gap-3"><svg
                            ...
                            <circle cx="12" cy="10" r="3"></circle>
                                                                               ...
                                                                               class="flex items-center gap-3 hover:text-primary transition-colors duration-300">
                        <svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        +201033455433</a><a href="mailto:info@kidanatravel.com"
                                            class="flex items-center gap-3 hover:text-primary transition-colors duration-300">
                        <svg
                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="border-t pt-10 text-center text-sm" style="border-top-color: #ffffff1a">
            ...
            <div
                ...
                <span><span class="text-primary-foreground/80 font-semibold">{{ __('footer.tourism_license') }}</span>
                    1908</span><span class="text-primary-foreground/30">|</span><span><span
                        class="text-primary-foreground/80 font-semibold">{{ __('footer.commercial_registration') }}</span>
                    200294</span><span class="text-primary-foreground/30">|</span><span><span
                        class="text-primary-foreground/80 font-semibold">{{ __('footer.tax_id') }}</span> 332-719-936</span>
            </div>
            ©
